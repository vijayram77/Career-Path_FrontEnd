            ...
            <div className=' relative '>
                <div ref={ref} className='w-full h-screen  relative flex  aboutus '>
                    ...
                    <div className='min-w-full h-full px-6 items-center flex flex-col justify-center relative'>
                        <Image width={600} height={600} src={Sameer.src} className='md:w-1/3 rounded-full absolute top-1/2 left-1/2 opacity-0 sameerimage -translate-x-1/2 -translate-y-1/2' />
                    ...
                    <div className='min-w-full h-full px-6 items-center flex flex-col justify-center relative'>
                        <Image width={600} height={600} src={vijay} className='md:w-1/3 rounded-full absolute top-1/2 left-1/2 opacity-0 vijayimage -translate-x-1/2 -translate-y-1/2' />
                        <div className='overflow-hidden'>
                    ...
                    <div className='min-w-full h-[400px] top-1/2 -translate-y-1/2 px-6 items-center flex flex-col justify-center py-24 relative'>
                        <Image width={600} height={600} src={suresh} className='md:w-1/3 md:h-[500px] h-[300px] rounded-full absolute top-1/2 left-1/2 opacity-0 sureshimage object-contain -translate-x-1/2 -translate-y-1/2' />
                        <div className='overflow-hidden'>
